...
<html lang="en">
  ...
  <div class="search-box">
    ...
    <section id="billboard" class="overflow-hidden">
      <div class="button-container d-flex justify-content-between align-items-center"> <!-- Nút qua trái qua phải -->
      ...
      <div class="swiper main-swiper">
        <div class="swiper-wrapper">
          <!-- Nếu muốn thêm 1 khung thì lấy từ đây -->
          <div class="swiper-slide" style="background-image: url('images/yeezydrop.jpg');background-repeat: no-repeat;background-size: cover;">
          ...
          <div class="swiper-slide" style="background-image: url('images/GettyImages-1344501637.jpg');background-repeat: no-repeat;background-size: cover;">
            <div class="banner-content">
              <div class="container">
                <div class="row">
                  <div class="col-md-6">
          ...
          <div class="swiper-slide" style="background-image: url('images/Balenciaga-Tshirt-Top-Image.jpg');background-repeat: no-repeat;background-size: cover;">
            <div class="banner-content">
              <div class="container">
                <div class="row">
                  <div class="col-md-6">
                      <h2 class="banner-title">TEST THÔI</h2>
                      <p>Đánh dấu thử thành công thêm slide bla blo</p>
                      <div class="btn-wrap">
                        <a href="#" class="btn btn-light btn-medium d-flex align-items-center" tabindex="0">Shop it now <i class="icon icon-arrow-io"></i>
                        </a>
                      </div>
          ...
          <div class="swiper-slide" style="background-image: url('images/DIOR_HAUTE\ COUTURE_SPRING-SUMMER_2020_GROUPSHOT_\ ©\ SARAH\ BLAIS\ .jpg');background-repeat: no-repeat;background-size: cover;">
            <div class="banner-content">
              <div class="container">
                <div class="row">
                  <div class="col-md-6">
          ...
          <!-- paste bđ từ đây --> <!-- chừa cái cmt ở dưới -->
        </div>
      </div>
