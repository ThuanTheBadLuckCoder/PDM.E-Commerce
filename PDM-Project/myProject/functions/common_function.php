...
function getproducts(){
    ...
    $select_query="Select * from `products`order by product_title LIMIT 0,6";
      ...
      while($row=mysqli_fetch_assoc($result_query)){
        ...
        echo "<div class='product-item col-lg-3 col-md-6 col-sm-6'> <!-- sản phẩm -->
        <div class='image-holder'>
          <img src='./admin_area/product_images/$product_image1' alt='Books' class='product-image'>
        </div>
        <div class='cart-concern'> <!-- add cart này nọ -->
          <div class='cart-button d-flex justify-content-between align-items-center'>
            <button type='button' class='btn-wrap cart-link d-flex align-items-center'>Add to cart <a href='display_all.php?add_to_cart=$product_id' class='icon icon-arrow-io'></a>
            </button>
            <a href='product_details.php?product_id=$product_id'>
            <button type='button' class='view-btn tooltip
                d-flex'>
              <i class='icon icon-screen-full'></i>
              <span class='tooltip-text'>View more</span>
            </button>
            </a>
          </div>
        </div> <!-- add cart này nọ -->
        <div class='product-detail'>
          ...
          <div class='item-price text-primary'>$$product_price</div>
        </div>
      </div>";
...
function get_all_products(){
  ...
  if(!isset($_GET['category'])){
      ...
      while($row=mysqli_fetch_assoc($result_query)){
        ...
        <div class='cart-concern'> <!-- add cart này nọ -->
          <div class='cart-button d-flex justify-content-between align-items-center'>
            Add to cart <a href='display_all.php?add_to_cart=$product_id' class='icon icon-arrow-io'></a>
