                  ...
                  <div class="main-menu stellarnav">
                    <ul class="menu-list list-unstyled">
                      <li class="menu-item active">
                        <a  data-effect="product">Products</a>
                      </li>
                      <li class="menu-item">
                        <a class="item-anchor" data-effect="Categories">Categories</a>
                        <ul class="dropdown-menu" style="background: white;"> <!-- Phần drop down -->
                          <li><a href="#tops">các kiểu 1</a></li>
                          <li><a href="#bottoms">các kiểu 2</a></li>
                          <li><a href="#accessories">các kiểu 3</a></li>
                        </ul>
                      </li>
                      <li class="menu-item">
